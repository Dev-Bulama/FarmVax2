                    ...
                    <tr class="hover:bg-gray-50 transition">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <span class="px-3 py-1 inline-flex text-xs leading-5 font-semibold rounded-full 
                                @if($user->role == 'farmer') bg-green-100 text-green-800
                       ...
                       <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
    @if(is_object($user->country) && isset($user->country->name))
        {{ $user->country->name }}
        @if(is_object($user->state) && isset($user->state->name)), {{ $user->state->name }}@endif
    @elseif($user->country_id)
        <span class="text-gray-400">Location ID: {{ $user->country_id }}</span>
    @else
