...
<div class="grid grid-cols-1 md:grid-cols-5 gap-4 mb-6">
    ...
    <div class="bg-white rounded-lg shadow p-6 border-l-4 border-yellow-500">
        <p class="text-sm text-gray-600">Contained</p>
        <p class="text-3xl font-bold text-yellow-600">{{ $stats['contained'] }}</p>
    </div>
                ...
                @forelse($alerts as $alert)
                    <tr class="hover:bg-gray-50 transition">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            ...
                            @elseif($alert->status == 'contained')
                                <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-yellow-100 text-yellow-800">Contained</span>
                            @else
