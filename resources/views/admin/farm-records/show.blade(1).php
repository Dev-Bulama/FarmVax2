        ...
        <div class="bg-white rounded-lg shadow p-6 sticky top-6">
            ...
            <div class="text-center pb-6 border-b">
                ...
                <div class="mt-3">
                    ...
                    @else
                        <span class="px-3 py-1 inline-flex text-sm font-semibold rounded-full bg-gray-100 text-gray-800">{{ ucfirst($record->status) }}</span>
                    @endif
                </div>
            </div>
            ...
            <div class="space-y-3 mt-6">
                <div>
                    ...
                    <p class="text-sm font-medium text-gray-900">{{ $record->creator_name }}</p>
                    <p class="text-sm text-gray-500">{{ $record->creator_email }}</p>
                </div>

                <div>
                    <p class="text-xs text-gray-500 uppercase font-semibold">Submitted Date</p>
                    <p class="text-sm text-gray-900">{{ \Carbon\Carbon::parse($record->created_at)->format('M d, Y h:i A') }}</p>
                </div>
...
@endif
        ...
        @if($record->livestock_type || $record->livestock_count)
            <div class="bg-white rounded-lg shadow">
                <div class="px-6 py-4 border-b border-gray-200">
        ...
        @if($record->attachments || $record->images)
            <div class="bg-white rounded-lg shadow">
                <div class="px-6 py-4 border-b border-gray-200">
                ...
                <div class="space-y-4">
                    ...
                    <div class="flex items-start">
                        ...
                        <div class="ml-3">
                            ...
                            <p class="text-sm text-gray-500">{{ \Carbon\Carbon::parse($record->created_at)->format('M d, Y h:i A') }}</p>
                            <p class="text-xs text-gray-400">By {{ $record->creator_name }}</p>
                        </div>
                    </div>
