            ...
            <div class="dropdown-section">
                ...
                <div id="records" class="dropdown-content hidden mt-1 ml-8 space-y-1">
                    <a href="{{ route('admin.livestock.index') }}"
                        class="flex items-center px-3 py-2 text-sm text-white rounded-md hover:bg-white/10 transition {{ request()->routeIs('admin.livestock.*') ? 'bg-white/10' : '' }}">
                        <svg class="mr-2 h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="dropdown-section">
                ...
                <div id="communication" class="dropdown-content hidden mt-1 ml-8 space-y-1">
                    ...
                    <a href="{{ route('admin.chatbot.index') }}"
                        class="flex items-center px-3 py-2 text-sm text-white rounded-md hover:bg-white/10 transition {{ request()->routeIs('admin.chatbot.*') ? 'bg-white/10' : '' }}">
                        <svg class="mr-2 h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<a href="{{ route('admin.import-export.index') }}"
   class="flex items-center px-4 py-3 text-gray-700 hover:bg-gray-100 transition {{ request()->routeIs('admin.import-export.*') ? 'bg-gray-100 border-r-4 border-blue-600' : '' }}">
    ...
    <span class="font-medium">Import/Export</span>
            ...
            <a href="{{ route('admin.health-check.index') }}"
               class="flex items-center px-3 py-2 text-sm font-medium text-white rounded-md transition {{ request()->routeIs('admin.health-check.*') ? 'bg-[#2FCB6E]/20 border-l-4 border-[#2FCB6E]' : 'hover:bg-white/10' }}">
                <svg class="mr-3 h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"/>
                </svg>
                Health & Diagnostics
