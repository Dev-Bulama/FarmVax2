            ...
            <div class="p-6">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <p class="text-base text-gray-900 mt-1">{{ $professional->professional_type_text }}</p>
                    </div>
                    <div>
                        <p class="text-sm text-gray-500 font-semibold">Specialization</p>
                        <p class="text-base text-gray-900 mt-1">{{ $professional->specialization ?? 'Not specified' }}</p>
                    </div>
                    <div>
                        <p class="text-sm text-gray-500 font-semibold">Service Area</p>
                        <p class="text-base text-gray-900 mt-1">{{ $professional->assigned_territory ?? 'Not specified' }}</p>
                    </div>
                    <div>
               ...
               @if($professional->organization)
                    <div class="mt-6">
                        <p class="text-sm text-gray-500 font-semibold">Organization</p>
                        <p class="text-base text-gray-900 mt-2">{{ $professional->organization }}</p>
                    </div>
                @endif
                ...
                @if($professional->experience_years)
                    <div class="mt-4">
                        ...
                        <p class="text-base text-gray-900 mt-1">{{ $professional->experience_years }} years</p>
                    </div>
                @endif
            </div>
        </div>
