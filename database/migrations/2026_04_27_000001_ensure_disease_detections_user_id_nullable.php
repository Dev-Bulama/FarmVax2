...
return new class extends Migration
{
     ...
     * Uses raw SQLite PRAGMA rebuild because ->change() fails on SQLite when the
     * original migration has a Schema::hasTable guard (schema introspection returns nothing).
     */
    ...
    {
        // No destructive rollback — leaving user_id nullable is always safe
    }
};
